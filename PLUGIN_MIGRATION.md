...
|   6 | aiven_aws_org_vpc_peering_connection        | yes    |     2 |
|   7 | aiven_aws_privatelink                       | yes    |     2 |
|   8 | aiven_aws_vpc_peering_connection            |        |     2 |
|   9 | aiven_azure_org_vpc_peering_connection      | yes    |     2 |
|  10 | aiven_azure_privatelink                     | yes    |     2 |
...
|  16 | aiven_byoc_permissions                      | yes    |     1 |
...
|  22 | aiven_clickhouse_user_settings              | yes    |     1 |
|  23 | aiven_cmk                                   | yes    |     1 |
|  24 | aiven_cmk_accessor_aws                      | yes    |     1 |
|  25 | aiven_cmk_accessor_azure                    | yes    |     1 |
|  26 | aiven_cmk_accessor_gcp                      | yes    |     1 |
|  27 | aiven_cmk_accessor_oci                      | yes    |     1 |
|  28 | aiven_connection_pool                       | yes    |     2 |
|  29 | aiven_dragonfly                             |        |     2 |
|  30 | aiven_external_identity                     | yes    |     1 |
|  31 | aiven_flink                                 |        |     2 |
|  32 | aiven_flink_application                     | yes    |     2 |
|  33 | aiven_flink_application_deployment          | yes    |     1 |
|  34 | aiven_flink_application_version             |        |     2 |
|  35 | aiven_flink_jar_application                 | yes    |     1 |
|  36 | aiven_flink_jar_application_deployment      | yes    |     1 |
|  37 | aiven_flink_jar_application_version         | yes    |     1 |
|  38 | aiven_gcp_org_vpc_peering_connection        | yes    |     2 |
|  39 | aiven_gcp_privatelink                       | yes    |     2 |
|  40 | aiven_gcp_privatelink_connection_approval   |        |     1 |
|  41 | aiven_gcp_vpc_peering_connection            |        |     2 |
|  42 | aiven_governance_access                     | yes    |     1 |
|  43 | aiven_grafana                               |        |     2 |
|  44 | aiven_kafka                                 |        |     2 |
|  45 | aiven_kafka_acl                             | yes    |     2 |
